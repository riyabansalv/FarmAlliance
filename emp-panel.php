...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center">FarmAlliance</h2></br>
...
.text-primary {
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-emp" id="list-emp-list"  role="tab" data-toggle="list" aria-controls="home">Landlords List</a>
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    ...
    <div class="tab-pane fade" id="list-emp" role="tabpanel" aria-labelledby="list-emp-list">
        ...
        echo "<thead><tr><th>Employee Name</th><th>Email</th><th>Phone</th></tr></thead>";
        echo "<tbody>";
