...
if(isset($_POST['empsub']))
{
  ...
  if($result)
    {
      echo "<script>alert('Landlords added successfully!');</script>";
  }
}
...
if(isset($_POST['empsub1']))
{
  ...
  if($result)
    {
      echo "<script>alert('Landlord removed successfully!');</script>";
  }
  else{
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> FarmAlliance</a>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-emp" id="list-emp-list"  role="tab"    aria-controls="home" data-toggle="list">Landlord List</a>
      <a class="list-group-item list-group-item-action" href="#list-user" id="list-user-list"  role="tab" data-toggle="list" aria-controls="home">Farmer List</a>
      ...
      <a class="list-group-item list-group-item-action" href="#list-settings" id="list-adoc-list"  role="tab" data-toggle="list" aria-controls="home">Add Landlord</a>
      <a class="list-group-item list-group-item-action" href="#list-settings1" id="list-ddoc-list"  role="tab" data-toggle="list" aria-controls="home">Delete Landlord</a>
               ...
               <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Landlords List</h4>
                      <script>
                ...
                <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Manage Landlords</h4>
                    
                      <p class="cl-effect-1">
                        <a href="#app-hist" onclick="clickDiv('#list-adoc-list')">Add Landlord</a>
                        &nbsp|
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  <div class="col-md-4"><label>Landlords Name:</label></div>
          ...
          <input type="submit" name="empsub" value="Add Landlords" class="btn btn-primary">
        </form>
      </div>
      ...
      <div class="tab-pane fade" id="list-settings1" role="tabpanel" aria-labelledby="list-settings1-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          ...
          <input type="submit" name="empsub1" value="Delete Landlords" class="btn btn-primary" onclick="confirm('Do you really want to delete?')">
        </form>
      </div>
